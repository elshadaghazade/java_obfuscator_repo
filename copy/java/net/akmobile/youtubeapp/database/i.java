...
SQLiteDatabase db = helper.getWritableDatabase();
String[] columns = {
SQLHelper.FILE_ID,SQLHelper.FILE_TITLE, SQLHelper.FILE_EXTENSION, SQLHelper.FILE_THUMBNAIL_PATH, SQLHelper.FILE_YOUTUBE_ID}
;
...
private static final String CREATE_FILES_TABlE = "CREATE TABLE IF NOT EXISTS "+FILES_TABLE_NAME+" ("+ FILE_ID+" INTEGER PRIMARY KEY AUTOINCREMENT, "+ FILE_TITLE+" VARCHAR(200), "+ FILE_THUMBNAIL_PATH+" VARCHAR(100), "+ FILE_EXTENSION+" VARCHAR(10), "+ FILE_CREATED_AT+" DATETIME DEFAULT CURRENT_TIMESTAMP, "+ FILE_YOUTUBE_ID+" VARCHAR(15), "+ "UNIQUE(" +FILE_YOUTUBE_ID+", "+FILE_EXTENSION + ") ON CONFLICT REPLACE);
";
...
if(mInstance==null) mInstance = new SQLHelper(context.getApplicationContext());
return mInstance;
}
@Override
